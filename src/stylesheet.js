...
const colorList = {
  ...
  inputHighlight: "rgba(187,247,208,1)"
};

const shadowList = {
  xs: "0px 1px 2px 0px rgba(42, 51, 66, 0.06)",
  md: "0px 2px 4px 0px rgba(42, 51, 66, 0.03), 0px 6px 10px 0px rgba(42, 51, 66, 0.06)",
  lg: "0px 4px 6px 0px rgba(42, 51, 66, 0.02), 0px 12px 16px 0px rgba(42, 51, 66, 0.03)",
  xl: "0px 8px 8px 0px rgba(42, 51, 66, 0.02), 0px 20px 24px 0px rgba(42, 51, 66, 0.03)",
  x2l: "0px 24px 48px 0px rgba(42, 51, 66, 0.06)",
  x3l: "0px 32px 64px 0px rgba(42, 51, 66, 0.08)",
  highlight: "0 0 0 4px " + colorList.inputHighlight
};
